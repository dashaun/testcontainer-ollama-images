...
class ImageGeneratorCommandTest {
    ...
    void parsesAndTrimsModelList() {
        assertThat(ImageGeneratorCommand.parseModels("phi4-mini, nomic-embed-text"))
                .containsExactly("phi4-mini", "nomic-embed-text");
        assertThat(ImageGeneratorCommand.parseModels("llama3.2:3b"))
                .containsExactly("llama3.2:3b");
    ...
    void stripsSpinnerNoiseFromPullErrors() {
        ...
        assertThat(ImageGeneratorCommand.lastLine(stderr))
                .isEqualTo("Error: pull model manifest: file does not exist");
    }
